...
public class Right extends PStatement
{
	...
	public Right(TopCode top, Extras ex)
	{
		super(top, ex);
		ext = ex;
	}
	...
	{
		StatementFactory.registerStatementType(new Right(new TopCode(CODE), new Extras()));
	}
	...
	{
		return new Right(top, ex);
	}

	public void compile(Program program)
	{
		setDebugInfo(program);
		program.addInstruction("d.right(" + ext.getDroneDistance() + "n);");
		if (this.next != null)
