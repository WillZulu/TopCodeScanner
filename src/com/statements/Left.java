...
public class Left extends PStatement
{
	...
	public Left(TopCode top, Extras ex)
	{
		super(top, ex);
		ext = ex;
	}
	...
	{
		StatementFactory.registerStatementType(new Left(new TopCode(CODE), new Extras()));
	}
	...
	{
		return new Left(top, ex);
	}

	public void compile(Program program)
	{
		setDebugInfo(program);
		program.addInstruction("d.left(" + ext.getDroneDistance() + ");");
		if (this.next != null)
